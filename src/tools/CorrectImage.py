...
parser.add_argument('--dataroot', type=str, default='res/', help='root directory of the dataset')
...
dataloader = DataLoader(ImageDataset(opt.dataroot, transforms_=transforms_, mode='test', img_size=(1024, 1024)),
