...
args = {
    'dataset_root': 'data/dataset_512_global_light',
    #'loss_list': ['l2+ssim+vggLoss', 'l1+l2+ssim+vggLoss', 'l1+vggLoss', 'l2+vggLoss', 'ssim+vggLoss', 'l1+l2+vggLoss'],
    'loss_list': ['l1+l2+ssim'],
    'loss': '',#it would be set later---
    'lambda': 1e-2,
    'model_name': 'Warpping-Net-Global',
    'log_dir': 'log',
    'nums_train': 3800, #how many images you suppose to train ,if 0 it will train all images
    'train_size': (256, 256),
    'prj_size': (512, 512),
    'epoch': 50,
    'batch_size': 256,
