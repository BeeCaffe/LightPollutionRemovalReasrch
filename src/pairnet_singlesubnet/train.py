...
import src.pairnet_singlesubnet.valid as valid
import src.pairnet_singlesubnet.bccn_model as bccn_model
import os
import torch
DEBUG = False
...
args = dict(dataset_root='datasets/dataset_512_no_gama_new/',
                ...
                # loss_list=['l2'],
                loss='',
                model_name='pairnet_singlesubnet',
                res_block_num_list=[3, 6, 9, 12],
                res_block_num=[],
                log_dir='log/',
    ...
    for back_gamma in args['back_gamma_lists']:
        for pro_gamma in args['pro_gamma_lists']:
            for is_train_mask in args['is_train_mask_list']:
                ...
                #load model
                model = bccn_model.Bccn_Net(args['weight'], res_block_num=args['res_block_num'])
