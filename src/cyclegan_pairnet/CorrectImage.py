...
parser.add_argument('--generator_A2B', type=str, default='checkpoint/cyclegan-pairnet/cyclegan-pairnet_5_8_1.0_1.2/netG_A2B.pth', help='A2B generator checkpoint file')
parser.add_argument('--generator_B2A', type=str, default='checkpoint/cyclegan-pairnet/cyclegan-pairnet_5_8_1.0_1.2/netG_B2A.pth', help='B2A generator checkpoint file')
parser.add_argument('--MaskNet', type=str, default='checkpoint/cyclegan-pairnet/cyclegan-pairnet_5_8_1.0_1.2/masknet_A.pth', help='B2A generator checkpoint file')

opt = parser.parse_args()

def compensate_img(A2Bpth, B2Apth, Maskpth, dataroot,optstr, batchSize=1, size = (1920, 1080)):
    ...
    file_name = 'output/cyclegan-pairnet/'+optstr
