...
import src.substractnet.utils as utils
import time
__DEBUG=False
...
args = {
    ...
    "save_path": r'F:\yandl\LightPollutionRemovalReasrch\output\substractnet/', #directory of save compensated images
    'checkpoint_path': r'F:\yandl\LightPollutionRemovalReasrch\checkpoint\compensationnet/',
